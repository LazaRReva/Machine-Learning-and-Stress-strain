...
output_dir = 'robust_ensemble_plots'
...
# For inverse gradient, clip extreme high values
...
# For gradient, also clip extreme high values just in case
    ...
    for i in range(n_members):
        ...
        for epoch in range(200):  # Increased epochs
            ...
            for inputs, targets in dataloader:
                ...
                loss.backward()
                # --- STABILITY STRATEGY 2: Gradient Clipping ---
...
for point_flat_index in points_to_plot:
    ...
    for tc in target_cycles:
        ...
        if idx > 0:  # Avoid marking the start point
