...
# 训练单个模型的函数
def train_model(train_loader, val_loader, input_size, num_epochs=30, learning_rate=1e-4, weight_decay=0.00001):
    ...
    for epoch in range(num_epochs):
        ...
        print(
            f"Epoch {epoch + 1}/{num_epochs}, Training Loss: {train_loss}, Validation Loss: {val_loss / len(val_loader)}")
...
for i in range(num_models):
    ...
    model, train_losses = train_model(train_loader, val_loader, input_size=9, num_epochs=30, learning_rate=1e-4,
...
plot_train_losses(all_train_losses)
